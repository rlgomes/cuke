...
describe('Config', () => {
  describe('constructor', () => {
    ...
    it('should initialize with empty data', () => {
      const config = new Config()
      // Config enumerates all environment variables, so it won't be empty
      // But it should be an instance of Config
      expect(config).toBeInstanceOf(Config)
      // The data property should be empty (but we can't access it directly)
      // So we verify it works by checking that setting a value works
  ...
  describe('getting values', () => {
    ...
    it('should return undefined for non-existent keys', () => {
      const config = new Config()
      const key = 'NON_EXISTENT_KEY_' + Date.now()
  ...
  describe('property descriptors', () => {
    ...
    it('should return undefined for non-existent properties', () => {
      const config = new Config()
      const key = 'NON_EXISTENT_' + Date.now()
